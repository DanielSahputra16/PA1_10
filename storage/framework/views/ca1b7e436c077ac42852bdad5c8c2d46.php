        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="wow fadeInUp" data-wow-delay="0.1s">
                    <a href="<?php echo e(route('admin.contact.create')); ?>" class="btn btn-primary mb-3">Tambah Informasi Kontak Baru</a>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>  <!-- Ubah foreach menjadi forelse -->
                                    <tr>
                                        ...
                                        <td class="text-center"> <!-- Tambahkan class text-center -->
                                            <a href="<?php echo e(route('admin.contact.edit', $contact->id)); ?>" class="btn btn-sm btn-warning me-1" title="Edit">  <!-- Ubah btn-primary menjadi btn-warning dan tambahkan me-1-->
                                                <i class="fas fa-edit"></i>  <!-- Tambahkan icon -->
                                            </a>
                                            <form action="<?php echo e(route('admin.contact.destroy', $contact->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus informasi kontak ini?')">  <!-- Tambahkan class d-inline -->
                                                <?php echo csrf_field(); ?>
