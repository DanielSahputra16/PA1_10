...
unset($__errorArgs, $__bag); ?>" id="name" name="name" placeholder="Your Name" value="<?php echo e(old('name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" placeholder="Your Email" value="<?php echo e(old('email')); ?>" required>
