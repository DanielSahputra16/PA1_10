...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="stok" name="stok" value="<?php echo e($menu->stok); ?>">
                                        </div>

                                        <div class="mb-3">
                                            <label for="detail" class="form-label">Detail Barang:</label>
                                            <textarea class="form-control" id="detail" name="detail"><?php echo e($menu->detail); ?></textarea>
                                        </div>
