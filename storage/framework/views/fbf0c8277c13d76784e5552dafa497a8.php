...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus placeholder="Alamat Email">
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="current-password" placeholder="Kata Sandi">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-between mb-4">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-decoration-none">Lupa Kata Sandi?</a>
                        <?php endif; ?>
                    </div>
