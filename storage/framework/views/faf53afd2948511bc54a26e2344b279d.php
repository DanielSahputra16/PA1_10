                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $reservasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(\Carbon\Carbon::parse($reservasi->tanggal_mulai)->isoFormat('D MMM YYYY, HH:mm')); ?></td>
                                            <td><?php echo e(\Carbon\Carbon::parse($reservasi->tanggal_selesai)->isoFormat('D MMM YYYY, HH:mm')); ?></td>
                                            <td>
                                                <span class="badge <?php echo e(getStatusBadgeClass($reservasi->status)); ?>"><?php echo e($reservasi->status); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <!-- Tombol Aksi -->
                                                <a href="<?php echo e(route('reservasi.show', $reservasi->id)); ?>" class="btn btn-sm btn-info me-1" title="Detail">
                                                ...
                                                <?php if(auth()->guard()->check()): ?>
                                                    <?php if(auth()->user()->id === $reservasi->user_id || auth()->user()->isAdmin()): ?>
                                                        <a href="<?php echo e(route('reservasi.edit', $reservasi->id)); ?>" class="btn btn-sm btn-warning me-1" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="<?php echo e(route('reservasi.destroy', $reservasi->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin membatalkan reservasi ini?');">
                                                            <?php echo csrf_field(); ?>
