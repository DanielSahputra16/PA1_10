                        ...
                        <div class="row g-4">
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-90 wow zoomIn" data-wow-delay="0.1s"
                                    src="<?php echo e(URL::asset('img/IMG-20250512-WA0010.jpg')); ?>" alt="">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-7 wow zoomIn" data-wow-delay="0.3s"
                                    src="<?php echo e(URL::asset('img/IMG-20250512-WA0008.jpg')); ?>" style="margin-top: 25%;"
                                    alt="">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s"
                                    src="<?php echo e(URL::asset('img/IMG-20250512-WA0021.jpg')); ?>" alt="">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-90 wow zoomIn" data-wow-delay="0.7s"
                                    src="<?php echo e(URL::asset('img/IMG-20250512-WA0020.jpg')); ?>" alt="">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-90 wow zoomIn" data-wow-delay="0.7s"
                                    src="<?php echo e(URL::asset('img/IMG-20250512-WA0006.jpg')); ?>" alt="">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s"
                                    src="<?php echo e(URL::asset('img/IMG-20250512-WA0023.jpg')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
