                    ...
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-90 wow zoomIn" data-wow-delay="0.1s" src="<?php echo e(URL::asset('img/about1.jpeg')); ?>">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-7 wow zoomIn" data-wow-delay="0.3s" src="<?php echo e(URL::asset('img/about3.jpeg')); ?>" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="<?php echo e(URL::asset('img/about2.jpeg')); ?>">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-90 wow zoomIn" data-wow-delay="0.7s" src="<?php echo e(URL::asset('img/about4.jpeg')); ?>">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-90 wow zoomIn" data-wow-delay="0.7s" src="<?php echo e(URL::asset('img/about3.jpeg')); ?>">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="<?php echo e(URL::asset('img/about2.jpeg')); ?>">
                            </div>
