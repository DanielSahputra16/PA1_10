    ...
    <div class="container-fluid pt-4 px-4">
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                ...
                <a href="<?php echo e(route('admin.Menu.create')); ?>" class="btn btn-primary mb-3">Tambah Menu</a>
                    ...
                    <table class="table table-striped table-bordered table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($menu->gambar): ?>
                                    <img src="<?php echo e(asset('storage/menus/' . $menu->gambar)); ?>" alt="<?php echo e($menu->judul); ?>"
                                        width="100">
                                    <?php else: ?>
                                    Tidak ada gambar
                                    <?php endif; ?>
