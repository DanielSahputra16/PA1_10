...
unset($__errorArgs, $__bag); ?>" id="title" name="title" value="<?php echo e(old('title')); ?>" required> <!-- Tambahkan class is-invalid -->
                        <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="invalid-feedback"><?php echo e($message); ?></div> <!-- Ubah text-danger menjadi invalid-feedback -->
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="3"><?php echo e(old('description')); ?></textarea> <!-- Tambahkan class is-invalid -->
...
unset($__errorArgs, $__bag); ?>" type="file" id="image" name="image" required> <!-- Tambahkan class is-invalid -->
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <a href="<?php echo e(route('admin.Galeri.index')); ?>" class="btn btn-secondary">Batal</a> <!-- Button Indonesia -->
                </form>
            </div>
        </div>
    </div>
