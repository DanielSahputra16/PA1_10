        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-2"><i class="fa fa-check text-primary me-3"></i><strong>ID Reservasi:</strong> #<?php echo e($reservasi->id); ?></p>
                    <p class="mb-2"><i class="fa fa-check text-primary me-3"></i><strong>Lapangan:</strong> <?php echo e($reservasi->lapangan->nama); ?></p>
                    <p class="mb-2"><i class="fa fa-check text-primary me-3"></i><strong>Tanggal Mulai:</strong> <?php echo e($reservasi->tanggal_mulai); ?></p>
                    <p class="mb-2"><i class="fa fa-check text-primary me-3"></i><strong>Tanggal Selesai:</strong> <?php echo e($reservasi->tanggal_selesai); ?></p>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="row img-twice position-relative h-100">
                        <div class="col-6 pe-0">
                            <img class="img-fluid rounded shadow-sm w-80 h-80" src="<?php echo e(URL::asset('img/download.jpeg')); ?>" style="object-fit: cover;">
                        </div>
                        <div class="col-6 ps-0">
                            <img class="img-fluid rounded shadow-sm w-100 h-95" src="<?php echo e(URL::asset('img/Lapangan2.jpg')); ?>" style="object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\PA_10\resources\views/reservasi/show.blade.php ENDPATH**/ ?>