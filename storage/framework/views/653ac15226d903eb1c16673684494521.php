    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-7 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                ...
                <div>
                    <a href="<?php echo e(route('admin.jadwal_lapangan.create')); ?>" class="btn btn-primary mb-3">Tambah Jadwal</a>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $jadwalLapangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwalLapangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-center"><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($jadwalLapangan->nama); ?></td>
                                    <td><?php echo e($jadwalLapangan->waktu_mulai); ?></td> <!-- Perbaikan di sini -->
                                    <td><?php echo e($jadwalLapangan->waktu_selesai); ?></td>
                                    <td class="text-center">
                                        <?php echo e($jadwalLapangan->lapangan_1 ? 'Dipakai' : 'Kosong'); ?></td>
                                    <td class="text-center">
                                        <?php echo e($jadwalLapangan->lapangan_2 ? 'Dipakai' : 'Kosong'); ?></td>
                                    <td class="text-center">
                                        <form
                                            action="<?php echo e(route('admin.jadwal_lapangan.destroy', $jadwalLapangan->id)); ?>"
                                            method="POST" style="display: inline-block;">
                                            <a class="btn btn-info btn-sm"
                                                href="<?php echo e(route('admin.jadwal_lapangan.show', $jadwalLapangan->id)); ?>">Show</a>
                                            <a class="btn btn-primary btn-sm"
                                                href="<?php echo e(route('admin.jadwal_lapangan.edit', $jadwalLapangan->id)); ?>">Edit</a>
                                            <?php echo csrf_field(); ?>
                            ...
                            <?php if($jadwalLapangans->isEmpty()): ?>
                                <tr>
