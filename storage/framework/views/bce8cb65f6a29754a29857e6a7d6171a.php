    ...
    <div class="container-fluid pt-4 px-4">
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                ...
                <a href="<?php echo e(route('admin.About.create')); ?>" class="btn btn-primary mb-3">Tambah Informasi</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="<?php echo e(route('admin.About.destroy', ['about' => $about->id])); ?>"
