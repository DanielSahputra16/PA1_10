...
unset($__errorArgs, $__bag); ?>" required
                                value="<?php echo e(old('nama', $reservasi->nama)); ?>">
...
unset($__errorArgs, $__bag); ?>" required
                                value="<?php echo e(old('no_hp', $reservasi->no_hp)); ?>">
                            ...
                            <select name="lapangan_id" id="lapangan_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $lapangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lapangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($lapangan->id); ?>"
                                        <?php echo e(old('lapangan_id', $reservasi->lapangan_id) == $lapangan->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tanggal_mulai" id="tanggal_mulai" class="form-control"
                                value="<?php echo e(old('tanggal_mulai', \Carbon\Carbon::parse($reservasi->tanggal_mulai)->format('Y-m-d'))); ?>"
                                required>
                        </div>
                            ...
                            <select name="jam_mulai" id="jam_mulai" class="form-select" required>
                                ...
                                <?php for($i = 8; $i <= 22; $i++): ?>
                                    <option value="<?php echo e(str_pad($i, 2, '0', STR_PAD_LEFT)); ?>:00"
                                        <?php echo e(old('jam_mulai', \Carbon\Carbon::parse($reservasi->tanggal_mulai)->format('H:i')) == str_pad($i, 2, '0', STR_PAD_LEFT) . ':00' ? 'selected' : ''); ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tanggal_selesai" id="tanggal_selesai" class="form-control"
                                value="<?php echo e(old('tanggal_selesai', \Carbon\Carbon::parse($reservasi->tanggal_selesai)->format('Y-m-d'))); ?>"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="jam_selesai" id="jam_selesai" class="form-select" required>
                                ...
                                <?php for($i = 8; $i <= 22; $i++): ?>
                                    <option value="<?php echo e(str_pad($i, 2, '0', STR_PAD_LEFT)); ?>:00"
                                        <?php echo e(old('jam_selesai', \Carbon\Carbon::parse($reservasi->tanggal_selesai)->format('H:i')) == str_pad($i, 2, '0', STR_PAD_LEFT) . ':00' ? 'selected' : ''); ?>>
                                        <?php echo e(str_pad($i, 2, '0', STR_PAD_LEFT)); ?>:00
                                    </option>
                                <?php endfor; ?>
                            </select>
