...
unset($__errorArgs, $__bag); ?>" id="lapangan_id"
                                ...
                                <?php $__currentLoopData = $lapangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lapangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($lapangan->id); ?>"
                                        <?php echo e((old('lapangan_id') == $lapangan->id) || ($reservasi->lapangan_id == $lapangan->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="tanggal_mulai"
                                name="tanggal_mulai" type="datetime-local"
                                value="<?php echo e(old('tanggal_mulai', \Carbon\Carbon::parse($reservasi->tanggal_mulai)->format('Y-m-d\TH:i'))); ?>"
                                required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control <?php $__errorArgs = ['tanggal_selesai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="tanggal_selesai"
                                name="tanggal_selesai" type="datetime-local"
                                value="<?php echo e(old('tanggal_selesai', \Carbon\Carbon::parse($reservasi->tanggal_selesai)->format('Y-m-d\TH:i'))); ?>"
                                required>
