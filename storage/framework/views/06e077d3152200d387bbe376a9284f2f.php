                    ...
                    <form action="<?php echo e(route('reservasi.update', $reservasi->id)); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="tanggal_mulai" name="tanggal_mulai" type="datetime-local"
                                value="<?php echo e(old('tanggal_mulai', \Carbon\Carbon::parse($reservasi->tanggal_mulai)->format('Y-m-d\TH:i'))); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="tanggal_selesai">Tanggal Selesai:</label>
                            <input class="form-control" id="tanggal_selesai" name="tanggal_selesai" type="datetime-local"
                                value="<?php echo e(old('tanggal_selesai', \Carbon\Carbon::parse($reservasi->tanggal_selesai)->format('Y-m-d\TH:i'))); ?>" required>
                        </div>
