            ...
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-2"><i class="fa fa-check text-primary me-3"></i><strong>Nama:</strong> {{ $reservasi->nama }}</p>
                        <p class="mb-2"><i class="fa fa-check text-primary me-3"></i><strong>No. HP:</strong> {{ $reservasi->no_hp }}</p>
                        <p class="mb-2"><i class="fa fa-check text-primary me-3"></i><strong>Lapangan:</strong> {{ $reservasi->lapangan->nama }}</p>
                        <p class="mb-2"><i class="fa fa-check text-primary me-3"></i><strong>Tanggal Mulai:</strong> {{ \Carbon\Carbon::parse($reservasi->tanggal_mulai)->isoFormat('D MMM YYYY, HH:mm') }}</p>
                        <p class="mb-2"><i class="fa fa-check text-primary me-3"></i><strong>Tanggal Selesai:</strong> {{ \Carbon\Carbon::parse($reservasi->tanggal_selesai)->isoFormat('D MMM YYYY, HH:mm') }}</p>
                        ...
                        <div class="row img-twice position-relative h-100">
                            <div class="col-6 pe-0">
                                <img class="img-fluid rounded shadow-sm w-80 h-80"
                                    src="{{ URL::asset('img/download.jpeg') }}" style="object-fit: cover;"
                                    alt="Gambar Lapangan">
                            </div>
                            <div class="col-6 ps-0">
                                <img class="img-fluid rounded shadow-sm w-100 h-95"
                                    src="{{ URL::asset('img/Lapangan2.jpg') }}" style="object-fit: cover;"
                                    alt="Gambar Lapangan">
                            </div>
                        </div>
                    </div>
