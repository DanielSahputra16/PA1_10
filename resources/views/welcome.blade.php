                    ...
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="{{URL::asset('img/IMG-20250512-WA0013.jpg')}}">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.3s" src="{{URL::asset('img/IMG-20250512-WA0008.jpg')}}">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="{{URL::asset('img/IMG-20250512-WA0023.jpg')}}">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.7s" src="{{URL::asset('img/IMG-20250512-WA0007.jpg')}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <a class="btn btn-primary py-3 px-5 mt-2" href="{{ route('About.indexPublic') }}">SEE MORE</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class="rounded-circle overflow-hidden m-4 d-flex justify-content-center align-items-center" style="width: 200px; height: 200px; margin: auto;">
                                <img src="{{URL::asset('img/yell-3.jpg')}}" alt="" style="width: 200px; height: 200px; object-fit: cover;">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class="rounded-circle overflow-hidden m-4 d-flex justify-content-center align-items-center" style="width: 200px; height: 200px; margin: auto;">
                                <img src="{{URL::asset('img/Tiara.jpg')}}" alt="" style="width: 200px; height: 200px; object-fit: cover;">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class="rounded-circle overflow-hidden m-4 d-flex justify-content-center align-items-center" style="width: 200px; height: 200px; margin: auto;">
                                <img src="{{URL::asset('img/Anggi.jpg')}}" alt="" style="width: 200px; height: 200px; object-fit: cover;">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class="rounded-circle overflow-hidden m-4 d-flex justify-content-center align-items-center" style="width: 200px; height: 200px; margin: auto;">
                                <img src="{{URL::asset('img/Debora.jpg')}}" alt="" style="width: 200px; height: 200px; object-fit: cover;">
                            </div>
