                            ...
                            <div class="row gy-4">
                                @if($contacts->isNotEmpty())
                                    ...
                                    <div class="col-12"> <!-- Instagram -->
                                        ...
                                        <p class="mb-0"><i class="fab fa-instagram text-primary me-2"></i><a href="https://instagram.com/{{ $contacts->first()->instagram_username }}" target="_blank">@ramos_badmintoncenter</a></p>
                                    </div>
                                @else
                                    <div class="col-12">
