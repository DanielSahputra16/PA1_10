            ...
            <div class="col-lg-6 register-form">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4 position-relative">
                        ...
                        <input id="name" type="text" class="form-control ps-5 @error('name') is-invalid @enderror"
                    ...
                    <div class="mb-4 position-relative">
                        ...
                        <input id="email" type="email" class="form-control ps-5 @error('email') is-invalid @enderror"
                    ...
                    <div class="mb-4 position-relative">
                        ...
                        <input id="password" type="password" class="form-control ps-5 @error('password') is-invalid @enderror"
                    ...
                    <div class="register-footer">
                        <p>Sudah mendaftar? <a href="{{ route('login') }}">Masuk di sini</a></p>
                    </div>
                </form>
            </div>
        </div>
